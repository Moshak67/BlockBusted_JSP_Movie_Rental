						...
						<sf:form action="processRegister" method="POST"
							...
							<div class="form-group row">
								<sf:label path="username" for="username"
									class="col-sm-2 col-form-label">Username</sf:label>
							...
							<div class="form-group row">
								<sf:label path="role" class="col-sm-2 col-form-label">Role</sf:label>
								<div class="col-sm-7">
									Admin: <sf:radiobutton path="role" value="admin"  />
									Customer: <sf:radiobutton path="role" value="customer"  />
